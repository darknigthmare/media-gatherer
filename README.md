...
`npm run qa` verifie la syntaxe du serveur et du frontend, puis execute les tests Node des contrats API, de la pertinence, du dedoublonnage, des exports et de la protection SSRF.
