...
7. Toutes les sources adultes utilisaient auparavant le meme extracteur generique.
   Correction initiale: registre de 22 adaptateurs NSFW avec domaines, chemins de resultats, types supportes et limite de pages. La version 1.4.2 porte ce total a 32.
